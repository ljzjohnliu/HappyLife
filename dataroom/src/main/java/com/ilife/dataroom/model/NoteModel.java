...
//    @PrimaryKey
    ...
    @Ignore
    public NoteModel(@NonNull long userId, @NonNull String date, @NonNull String title, String content) {
        this(userId, date, title, content, null, null, null, false, null, false, null);
    }

    public NoteModel(@NonNull long userId, @NonNull String date, @NonNull String title, String content, String place, String startTime,
                     String endTime, boolean isAllDay, String remindBeforeTime, boolean isRepeat, String ring) {
        this.userId = userId;
        this.date = date;
        this.title = title;
    ...
    public String toString() {
        return "Note { userId: " + userId + ", date : " + date
